...
# If there is a match then the dynamoDB entry is modified to signify the GE.EVES Robot should proceed to the corresponding coordinates
...
def no_user_found():
    ...
    speech_output = "I could not find a match for the name you provided. " \
		    ...
		    "Please phrase your request the same as given in the following example. " \
		    "Show me to the office of Jane Smith. " \
	            "Otherwise, just say stop to canel your search. "
    reprompt_text = "I'm not sure whose office you want to find. " \
                    "Please phrase your request the same as given in the following example. " \
		    "Show me to the office of Jane Smith. " \
		    "Otherwise, just say stop to cancel your search. "
    should_end_session = False
