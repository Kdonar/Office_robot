# office_hitchhiker_rev2b.py

# NOT COMPLETE .... Adding msg for activation of arduino servo for head rotation
# Otherwise, base software was functional for demo in lab 1204
