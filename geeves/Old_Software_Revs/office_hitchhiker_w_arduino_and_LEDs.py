# office_hitchhiker_w_arduino_and_LEDs.py
...
# Update made off office_hitchhiker_w_arduino.py
...
class OfficeHitchhiker():
    ...
    def RobotBattery(self, data):

        # Information to inform Arduino to turn put LEDs into 'at docking station' state
